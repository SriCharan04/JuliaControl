...
"""
@component function RelativeSpeedSensor(; name)
...
export RelativeSpeedSensor

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(RelativeSpeedSensor)) = print(io,
