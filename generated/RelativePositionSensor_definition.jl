...
"""
@component function RelativePositionSensor(; name)
...
export RelativePositionSensor

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(RelativePositionSensor)) = print(io,
